...
if (xpDoHeroi <= 1000) {
    ...
    respostaUsuario.innerHTML = nomeDoHeroi + " você é novo por aqui. "
    eloUsuario.innerHTML = "Elo: Ferro "
} else 
if (xpDoHeroi > 1000 &&  xpDoHeroi<= 2000) {
    console.log("Tem muito que evoluir ainda! elo: Bronze")
    respostaUsuario.innerHTML = nomeDoHeroi + " Tem muito que evoluir ainda! "
 ...
 if (xpDoHeroi > 2001 && xpDoHeroi<= 5000) {
    ...
    respostaUsuario.innerHTML = nomeDoHeroi + " Não tem porque parar agora continue evoluindo! elo: Prata"
    eloUsuario.innerHTML = "Elo: Prata "
} else
 if (xpDoHeroi > 5000 && xpDoHeroi <= 7000) {
    console.log("Talvez um dia você será lembrado! elo: Ouro")
    respostaUsuario.innerHTML = nomeDoHeroi + " Talvez um dia você será lembrado! "
    eloUsuario.innerHTML = "Elo: Ouro "
} else
 if (xpDoHeroi > 7000 && xpDoHeroi <= 8000) {
    console.log("Aqui é onde os fracos desistem! elo: PLatina")
    respostaUsuario.innerHTML = nomeDoHeroi + " Aqui é onde os fracos desistem! "
 ...
 if (xpDoHeroi > 8000 && xpDoHeroi <= 9000) {
    ...
    respostaUsuario.innerHTML = nomeDoHeroi + " você ainda não esta pronto para me enfrentar, fraco! "
...
if (xpDoHeroi > 10000) {
    ...
    respostaUsuario.innerHTML = nomeDoHeroi + " ,você é digno de sentar ao meu lado em uma taverna, vem vamos tomar uma!"
